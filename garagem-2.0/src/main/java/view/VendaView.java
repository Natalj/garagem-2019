        ...
        for (Venda v : vendaController.listar()) {
            ...
            System.out.println(
                    "Código venda: " + v.getCodigo() +
                            ...
                            "\n" + "Nome entity.Marca: " + automovel.getNome() +
                            "\n" + "Nome entity.Modelo: " + automovel.getNome_modelo() +
