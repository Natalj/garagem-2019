...
public class ModeloModel {
    ...
    public List<Modelo> listar() {
        ...
        try {
            ...
            while(rset.next()){
                ...
                modelo.setNome_modelo(rset.getString("nomeModelo"));

                modelo.setTipo(rset.getString("tipo"));

                modelo.setNome_modelo(rset.getString("nomeMarca"));
    ...
    public boolean cadastrar(Modelo modelo, int idMarca) {
        ...
        try {
            ...
            ps.setString(1, modelo.getNome_modelo());
    ...
    public boolean alterar(Modelo modelo) {
        ...
        try {
            ...
            pstm = connection.prepareStatement(sql);
            pstm.setString(1,modelo.getNome_modelo());
    ...
    public Modelo buscar(int id) {
        ...
        try {
            ...
            while(rset.next()){
                ...
                modelo.setNome(rset.getString("nomeMarca"));
