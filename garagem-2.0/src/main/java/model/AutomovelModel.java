    ...
    public List<Automovel> listar(){
        ...
        try {
            ...
            while(rset.next()){
                ...
                automovel.setNome(rset.getString("nomeMarca"));

                automovel.setNome_modelo(rset.getString("nomeModelo"));

                automovel.setTipo(rset.getString("tipo"));

                automovel.setCor(rset.getString("cor"));

                automovel.setAno_fab(rset.getDate("anoFabricacao"));

                automovel.setAno_modelo(rset.getDate("anoModelo"));
